...
scan:
                        mov                     ebx, [esi + 1Ch]
                        mov                     temp [0], ebx
                        mov                     edx, [esi + 20h] ; префетч+копирование
                        mov                     temp [4], edx
                        ; спарить латентные комманды
                        mov                     edx, dword ptr [esi + 1Dh]
;---------------------- ----------------------- ---------------------------
                        N = 0
                        ; Начало сравнений
                        REPT                    0Dh
                        ...
                        ENDM
;---------------------- ----------------------- ---------------------------
                        ; Избегание попаданий на границу кэша
                        ;cmp                     edx, esp
                        ;regst                   %nn, a          ; С использованием латентного кода
                        Compset                 a, 1Dh
                        cmp                     temp [1], esp
                        regst                   %nn, c
                        Compset                 a, 1Eh
