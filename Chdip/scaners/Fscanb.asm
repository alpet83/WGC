...
;db                      8  dup (90h)
;---------------------- ----------------------- ---------------------------
ScanBYTES              PROC STDCALL uses eax ebx ecx edx esi edi ebp, buff:DWORD, rslt:DWORD, bsize:DWORD
                        ; Loading buffer info
			mov                     esi, buff  ; ebp + 08
                        mov                     edi, rslt  ; ebp + 0C
...
;---------------------- ----------------------- ---------------------------
                        ...
                        compsetb                 a, 0Fh, 17        ; 16 middle bits - set
                        compsetb                 c, 1Fh            ; 16 high bits - set
                        compsetb                 d, 2Fh, 17
                        compsetb                 b, 3Fh
;=============== ДОУПАКОВКА МНОЖЕСТВ --------------------------------------------------
...
; SCANING LOOP COMPLETE  - Цикл сканирования завершен
                        ...
                        mov                     _packalg, RLESET
                        ret
ScanBYTES              ENDP                   ; ScanBYTES

ALIGN 16                
;---------------------- ----------------------- ---------------------------
SieveBYTES             PROC  STDCALL uses eax ebx ecx edx esi edi ebp,   buff:DWORD, setlst:DWORD, dst:DWORD, count:DWORD
